...
class MailController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $mails = $em->getRepository('AdminBundle:Mail')->findAll();
    ...
    {
        $mail = new Mail();
        $form = $this->createForm('AdminBundle\Form\MailType', $mail);
    ...
    {
        $deleteForm = $this->createDeleteForm($mail);
        $editForm = $this->createForm('AdminBundle\Form\MailType', $mail);
