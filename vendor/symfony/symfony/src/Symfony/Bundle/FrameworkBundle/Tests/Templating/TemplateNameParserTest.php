...
class TemplateNameParserTest extends TestCase
{
    ...
    public function parseProvider()
    {
        return array(
            ...
            array('FooBundle:Post:baseAdmin.html.twig', 'FooBundle:Post:baseAdmin.html.twig', '@FooBundle/Resources/views/Post/baseAdmin.html.twig', new TemplateReference('FooBundle', 'Post', 'index', 'html', 'twig')),
